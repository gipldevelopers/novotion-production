...
const MOCK_CUSTOM_SERVICES = [
    ...
    },
    {
        ...
        price: 2500,
        description: 'Full-scale career management and placement guarantee for senior leadership roles and specialized IT domains.',
        icon: Rocket,
        features: [
            'Comprehensive Career Transformation',
            'Dedicated Career Success Manager',
            'VIP Access to Hidden Job Market',
            'Personal Branding & Content Strategy',
            'Lifetime Access to Professional Network',
            'Interview Proxy & Technical Support'
        ],
        badge: 'Premium',
        color: 'slate'
    }
...
const CustomServicesPage = () => {
    ...
    const handleAddToCart = (pkg) => {
        ...
        toast.success(`${pkg.name} added to cart!`, {
            description: "You've successfully added this custom service. Check your cart to proceed.",
            duration: 3000,
            action: {
                label: 'View Cart',
        ...
        <div className="min-h-screen bg-white">
            ...
            <section className="relative pt-32 pb-20 overflow-hidden bg-slate-900 text-white">
                ...
                <div className="container mx-auto px-6 relative z-10 text-center">
                    ...
                    <p className="text-lg md:text-xl text-slate-400 max-w-2xl mx-auto leading-relaxed">
                        Your career journey is unique. Our custom services are designed to provide the specific support you need to overcome any obstacle and reach your professional goals.
                    </p>
                </div>
            </section>
                        ...
                        {services.map((pkg) => (
                            ...
                            >
                                ...
                                <div className="relative p-8 md:p-10 h-full flex flex-col">
                                    ...
                                    <div className="mb-8">
                                        <div className={`h-16 w-16 rounded-2xl ${pkg.color === 'blue' ? 'bg-blue-50 text-blue-600' : pkg.color === 'indigo' ? 'bg-indigo-50 text-indigo-600' : 'bg-slate-100 text-slate-800'} flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-500 border border-current/10 shadow-sm`}>
                                            <pkg.icon className="h-8 w-8" />
                                        </div>
                                        <h3 className="text-3xl font-black text-slate-900 mb-3">{pkg.name}</h3>
                                        <p className="text-slate-500 leading-relaxed font-medium text-sm">{pkg.description}</p>
                                    </div>
                                    ...
                                    <div className="mb-10 p-6 rounded-3xl bg-white border border-slate-100 shadow-sm">
                                        <div className="flex items-baseline gap-1">
                                            ...
                                            <span className="text-slate-400 font-bold uppercase tracking-tight text-xs">/ Total</span>
                                        </div>
                ...
                <div className="container mx-auto px-6">
                    <div className="max-w-4xl mx-auto">
                        <div className="text-center mb-16">
                            <h2 className="text-3xl md:text-5xl font-black text-slate-900 mb-6">Why Choose Custom Solutions?</h2>
                            <p className="text-lg text-slate-500 font-medium">Generic solutions provide generic results. Custom services are built around your specific needs.</p>
                        </div>
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            {[
                                ...
                                <div key={idx} className="bg-white p-8 rounded-3xl border border-slate-100 shadow-sm flex gap-6 items-start group hover:border-blue-500 transition-colors">
            ...
            <section className="py-20 bg-blue-600 relative overflow-hidden">
                ...
                <div className="container mx-auto px-6 relative z-10 text-center text-white">
                    <h2 className="text-3xl md:text-4xl font-black mb-6">Still Not Sure Which Package is Right?</h2>
                    <p className="text-blue-100 text-lg mb-10 max-w-xl mx-auto">Schedule a free 15-minute consultation with one of our career strategists to find your perfect fit.</p>
